...
import { CardProduto } from './components/Layout/Card/CardProduto';
...
function App() {
  ...
  return (
    <MobileContainer>
      {/* Container principal que ocupa a tela toda e divide em duas áreas: Scroll e Rodapé fixo */}
      <div style={{ height: '100vh', display: 'flex', flexDirection: 'column', backgroundColor: '#f8f9fa' }}>
          
        {/* 1. ÁREA DE CONTEÚDO COM SCROLL (O flex: 1 faz ela ocupar todo o espaço livre) */}
        <div style={{ 
          flex: 1, 
          overflowY: 'auto', 
          paddingBottom: '20px', 
          ...
          <div style={{ 
            ...
            {/* ADICIONADO: Flex container para alinhar textos à esquerda e sino à direita */}
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
              <div>
                <h2 style={{ margin: 0 }}>Olá, Bem Vindo! 👋</h2>
                <p style={{ opacity: 0.8, fontSize: '12px'}}>Monitore seus produtos e receba
                  <br />
                 alertas quando o preço cair
                </p>
              </div>
              
              {/* ADICIONADO: Ícone do Sino com ponto de notificação */}
            ...
            {/* ADICIONADO: Wrapper relativo para colocar a lupa dentro do input */}
            <div style={{ position: 'relative', marginTop: '15px' }}>
              ...
              <input 
                ...
                style={{ 
                  ...
                  padding: '14px 20px 14px 45px', /* Ajustado para 45px na esquerda para dar espaço à lupa */
                  borderRadius: '25px',       
                  border: 'none',             
                  display: 'block',
                  outline: 'none',
          ...
          {/* Área de Listas (Produtos e Histórico) */}
          <div style={{ padding: '0 20px', marginTop: '20px' }}>
            ...
            {/* NOVO TÍTULO: Histórico com "Ver todos" */}
